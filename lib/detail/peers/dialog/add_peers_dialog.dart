...
class AddPeersDialog extends StatefulWidget {
  ...
  final TorrentPeersViewModel viewModel;
  ...
  static Future<void> show({
    ...
    return showGeneralDialog<void>(
      ...
      pageBuilder: (ctx, animation, secondaryAnimation) {
        return AddPeersDialog(animation: animation, viewModel: viewModel);
      },
  ...
  @override
  State<AddPeersDialog> createState() => _AddPeersDialogState();
}

class _AddPeersDialogState extends State<AddPeersDialog> {
  ...
  Future<void> _submit() async {
    ...
    final error = await widget.viewModel.addPeers(_controller.text);
    if (!mounted) return;
    if (error != null) {
      setState(() {
        _submitting = false;
